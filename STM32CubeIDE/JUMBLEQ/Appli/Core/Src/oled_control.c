...
void OLED_UpdateTask(void)
{
    ...
    */
    ...
    // all clear
    sub_oled_FillRectangle(0, 0, 127, 64, Black);

    sub_oled_SetCursor(1, 5);
    sub_oled_WriteString(get_current_input_srcA_str(), Font_7x10, White);
    sub_oled_SetCursor(90, 5);
    sub_oled_WriteString(get_current_input_srcB_str(), Font_7x10, White);
    ...
    sub_oled_WriteString(get_current_input_typeA_str(), Font_7x10, White);
    sub_oled_SetCursor(77, 30);
    sub_oled_WriteString(get_current_input_typeB_str(), Font_7x10, White);

    sub_oled_SetCursor(1, 50);
    sub_oled_WriteString(get_current_input_srcP_str(), Font_7x10, White);
    sub_oled_UpdateScreen();
}
